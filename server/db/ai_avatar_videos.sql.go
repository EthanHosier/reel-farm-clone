...
func (q *Queries) CreateVideo(ctx context.Context, arg *CreateVideoParams) (*AiAvatarVideo, error) {
...
SELECT id, title, description, filename, thumbnail_filename, duration, file_size, created_at, updated_at FROM ai_avatar_videos
ORDER BY created_at DESC
`

func (q *Queries) GetAllVideos(ctx context.Context) ([]*AiAvatarVideo, error) {
...
func (q *Queries) GetVideoByID(ctx context.Context, id uuid.UUID) (*AiAvatarVideo, error) {
...
func (q *Queries) UpdateVideo(ctx context.Context, arg *UpdateVideoParams) (*AiAvatarVideo, error) {
